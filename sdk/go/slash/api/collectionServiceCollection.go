...
type CollectionServiceCollection struct {
	...
	ShortcutIds pulumi.IntArrayOutput    `pulumi:"shortcutIds"`
...
type CollectionServiceCollectionArgs struct {
	...
	ShortcutIds pulumi.IntArrayInput
...
func (o CollectionServiceCollectionOutput) ShortcutIds() pulumi.IntArrayOutput {
	return o.ApplyT(func(v *CollectionServiceCollection) pulumi.IntArrayOutput { return v.ShortcutIds }).(pulumi.IntArrayOutput)
}
