...
class Apiv1Collection(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "createdTime":
            ...
            suggest = "creator_id"
        elif key == "shortcutIds":
            suggest = "shortcut_ids"
    ...
    def __init__(__self__, *,
                 ...
                 shortcut_ids: Optional[Sequence[int]] = None,
    ...
    def shortcut_ids(self) -> Optional[Sequence[int]]:
...
@pulumi.output_type
class GetShortcutAnalyticsResponseAnalyticsItem(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class V1GetShortcutAnalyticsResponse(dict):
    def __init__(__self__, *,
                 browsers: Optional[Sequence['outputs.GetShortcutAnalyticsResponseAnalyticsItem']] = None,
                 devices: Optional[Sequence['outputs.GetShortcutAnalyticsResponseAnalyticsItem']] = None,
                 references: Optional[Sequence['outputs.GetShortcutAnalyticsResponseAnalyticsItem']] = None):
    ...
    @property
    @pulumi.getter
    def browsers(self) -> Optional[Sequence['outputs.GetShortcutAnalyticsResponseAnalyticsItem']]:
        return pulumi.get(self, "browsers")

    @property
    @pulumi.getter
    def devices(self) -> Optional[Sequence['outputs.GetShortcutAnalyticsResponseAnalyticsItem']]:
        return pulumi.get(self, "devices")

    @property
    @pulumi.getter
    def references(self) -> Optional[Sequence['outputs.GetShortcutAnalyticsResponseAnalyticsItem']]:
