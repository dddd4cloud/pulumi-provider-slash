...
import (
	...
	providerSchemaGen "github.com/dddd4cloud/pulumi-provider-slash/provider/pkg/gen"
	providerVersion "github.com/dddd4cloud/pulumi-provider-slash/provider/pkg/version"
...
func main() {
	flag.Usage = func() {
		const usageFormat = "Usage: %s <language> <schema-file> <root-pulumi-slash-dir>"
	...
	case Schema:
		...
		providerDir := filepath.Join(".", "provider", "cmd", "pulumi-resource-slash")
